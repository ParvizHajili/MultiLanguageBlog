    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2022, 10, 25, 12, 4, 45, 791, DateTimeKind.Local).AddTicks(2651), "x.jpg", null });

            migrationBuilder.InsertData(
                table: "Blogs",
                columns: new[] { "Id", "CreatedDate", "PhotoUrl", "UpdatedDate" },
                values: new object[] { 2, new DateTime(2022, 10, 25, 12, 4, 45, 791, DateTimeKind.Local).AddTicks(2653), "y.jpg", null });

            migrationBuilder.InsertData(
                table: "Blogs",
                columns: new[] { "Id", "CreatedDate", "PhotoUrl", "UpdatedDate" },
                values: new object[] { 3, new DateTime(2022, 10, 25, 12, 4, 45, 791, DateTimeKind.Local).AddTicks(2653), "x.jpg", null });
